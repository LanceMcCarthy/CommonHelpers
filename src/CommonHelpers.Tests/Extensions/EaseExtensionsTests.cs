...
{
    private const float TestInputValue = 0.23f;

    [TestMethod]
    public void BackEases()
    {
        var easeIn = TestInputValue.BackEaseIn();
        var easeOut = TestInputValue.BackEaseOut();

        Assert.IsTrue(easeIn < TestInputValue, "The Back easeIn value is not correct");
        Assert.IsTrue(easeOut > TestInputValue, "The Back easeOut value is not correct");
    }
    ...
    {
        var easeIn = TestInputValue.BounceEaseIn();
        var easeOut = TestInputValue.BounceEaseOut();

        Assert.IsTrue(easeIn < TestInputValue, "The Bounce easeIn value is not correct");
        Assert.IsTrue(easeOut > TestInputValue, "The Bounce easeOut value is not correct");
    }
    ...
    {
        var easeIn = TestInputValue.CubicEaseIn();
        var easeOut = TestInputValue.CubicEaseOut();

        Assert.IsTrue(easeIn < TestInputValue, "The Cubic easeIn value is not correct");
        Assert.IsTrue(easeOut > TestInputValue, "The Cubic easeOut value is not correct");
    }
    ...
    {
        var easeIn = TestInputValue.CircularEaseIn();
        var easeOut = TestInputValue.CircularEaseOut();

        Assert.IsTrue(easeIn < TestInputValue, "The Circular easeIn value is not correct");
        Assert.IsTrue(easeOut > TestInputValue, "The Circular easeOut value is not correct");
    }
    ...
    {
        var easeIn = TestInputValue.ElasticEaseIn();
        var easeOut = TestInputValue.ElasticEaseOut();

        Assert.IsTrue(easeIn < TestInputValue, "The Elastic easeIn value is not correct");
        Assert.IsTrue(easeOut > TestInputValue, "The Elastic easeOut value is not correct");
    }
    ...
    {
        var easeIn = TestInputValue.ExponentialEaseIn();
        var easeOut = TestInputValue.ExponentialEaseOut();

        Assert.IsTrue(easeIn < TestInputValue, "The Exponential easeIn value is not correct");
        Assert.IsTrue(easeOut > TestInputValue, "The Exponential easeOut value is not correct");
    }
    ...
    {
        var ease = TestInputValue.Linear();

        Assert.IsTrue(Math.Abs(ease - TestInputValue) < 0.01, "The Linear ease value is not correct");
    }
    ...
    {
        var easeIn = TestInputValue.QuadraticEaseIn();
        var easeOut = TestInputValue.QuadraticEaseOut();

        Assert.IsTrue(easeIn < TestInputValue, "The Quadratic easeIn value is not correct");
        Assert.IsTrue(easeOut > TestInputValue, "The Quadratic easeOut value is not correct");
    }
    ...
    {
        var easeIn = TestInputValue.QuarticEaseIn();
        var easeOut = TestInputValue.QuarticEaseOut();

        Assert.IsTrue(easeIn < TestInputValue, "The Quartic easeIn value is not correct");
        Assert.IsTrue(easeOut > TestInputValue, "The Quartic easeOut value is not correct");
    }
    ...
    {
        var easeIn = TestInputValue.QuinticEaseIn();
        var easeOut = TestInputValue.QuinticEaseOut();

        Assert.IsTrue(easeIn < TestInputValue, "The Quintic easeIn value is not correct");
        Assert.IsTrue(easeOut > TestInputValue, "The Quintic easeOut value is not correct");
    }
    ...
    {
        var easeIn = TestInputValue.SineEaseIn();
        var easeOut = TestInputValue.SineEaseOut();

        Assert.IsTrue(easeIn < TestInputValue, "The Sine easeIn value is not correct");
        Assert.IsTrue(easeOut > TestInputValue, "The Sine easeOut value is not correct");
    }
